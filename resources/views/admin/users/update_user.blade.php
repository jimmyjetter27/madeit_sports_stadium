...
<div class="flex flex-col md:flex-row">
    ...
    <main class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Update User</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="m-20 w-1/3">
            <h1 class="mb-3 font-bold">Update User Account Details</h1>
            <p>
                @if(\Illuminate\Support\Str::of($user->name)->endsWith('s'))
                    Make changes to {{ $user->name }}' details
                @else
                    Make changes to {{ $user->name }}'s details
                @endif
            </p>
